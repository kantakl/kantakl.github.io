...
scale.select("#scaleRect")
  ...
  function fetchData() {
    ...
    d3.select(svg, function(error, data) {
          console.log(data);
  
  
  
              var xScale = d3.scaleBand()
                   .domain(["Boxing", "Ice Hockey", "Football", "Arkansas", "California", "Colorado", "Connecticut",
            ...
            var stops = d3.range(0, 1, 0.25);
               ...
               var bar = svg.selectAll("rect")
                   ...
                   .append("rect")
                     ...
                     .attr("y", function(d) { return yScale(d.ensurance); })
